...
- Columns were renamed on 2026-09-25 (`modeled_pnl` became `pnl`, and so on). Since 2026-09-26 published P&L deducts the all-in cost above; earlier versions of this repository showed P&L before it.
